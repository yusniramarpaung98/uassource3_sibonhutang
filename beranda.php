    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SI BON BMT SEJAHTERA</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">PELANGGAN BMT SEJAHTERA</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nomor Pelanggan</th><th width="30%">Nama Pelanggan</th><th>Alamat</th><th>Nomor HP</th><th>Kantor</th>
                            </tr>
                        </thead>
                        <tbody>
